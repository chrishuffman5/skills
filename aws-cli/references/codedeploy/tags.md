...
CodeDeploy supports the standard AWS resource tagging pattern for applications, deployment groups, and deployment configurations.

---

### 7.1 `tag-resource`

Associates tags with a CodeDeploy resource (application, deployment group, or deployment configuration).
...
Removes tags from a CodeDeploy resource.
